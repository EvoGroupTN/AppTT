...
<html>
  ...
  function loadstep(num){
      ...
      switch(num){
          case 1:
              loadtab(1);
              document.getElementById("step-holder").innerHTML = '<div class="step-no">1</div><div class="step-done-left"><a href="#" onclick="loadtab(1);">En Etude</a></div><div class="step-done-right">&nbsp;</div><div class="step-no-off">2</div><div class="step-light-left"><a>En Déploiement</a></div><div class="step-light-right">&nbsp;</div><div class="step-no-done">3</div><div class="step-light-left">En Service</div><div class="step-light-round">&nbsp;</div><div class="clear"></div>';
              break;
          case 2:
              loadtab(2);
              document.getElementById("step-holder").innerHTML = '<div class="step-no-done">1</div><div class="step-dark-left"><a href="#" onclick="loadtab(1);">En Etude</a></div><div class="step-dark-right">&nbsp;</div><div class="step-no-done">2</div><div class="step-done-left"><a href="#" onclick="loadtab(2);">En Déploiement</a></div><div class="step-done-right">&nbsp;</div><div class="step-no-off">3</div><div class="step-light-left">En Service</div><div class="step-light-round">&nbsp;</div><div class="clear"></div>';
              break;
          case 3:
              loadtab(3);
              document.getElementById("step-holder").innerHTML = '<div class="step-no">1</div><div class="step-dark-left"><a href="#" onclick="loadtab(1);">En Etude</a></div><div class="step-dark-right">&nbsp;</div><div class="step-no">2</div><div class="step-dark-left"><a href="#" onclick="loadtab(2);">En Déploiement</a></div><div class="step-dark-right">&nbsp;</div><div class="step-no">3</div><div class="step-done-left"><a href="#" onclick="loadtab(3);">En Service</a></div><div class="step-done-round">&nbsp;</div><div class="clear"></div>';
              break;
      }
      $("#step-holder").show("slow");
  }
...
<div class="nav-outer"> 
		...
		<ul class="select"><li><a href="index.jsp"><b>Accueil</b><!--[if IE 7]><!--></a><!--<![endif]-->
		...
		<!--[if lte IE 6]></td></tr></table></a><![endif]-->
                    ...
                    <ul class="select" onclick=""><li><a href="#nogo" onclick="loadtodiv('#right-content','homediv.jsp');"><b>Sites</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		...
		<ul class="select"><li><a href="#nogo"><b>Equipement</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		...
		<!--[if lte IE 6]></td></tr></table></a><![endif]-->
                    ...
                    <ul class="select"><li><a href="add.jsp" target="frminfo" onclick="showinfo()"><b>Assistant d'Ajout</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		...
		<!--[if lte IE 6]></td></tr></table></a><![endif]-->
                    ...
                    <ul class="select"><li><a href="#nogo" onclick="loadtodiv('#right-content','user.jsp')"><b><%=session.getAttribute("user").toString()%></b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		...
		<!--[if lte IE 6]></td></tr></table></a><![endif]-->
                    ...
                    <ul class="select"><li><a href="actions?action=logout"><b>Logout</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
	...
	<div id="related-activities">
		...
		<div id="related-act-bottom">
			...
			<div id="related-act-inner">
					...
					<div class="search" >
                                            <h5>Chercher un site:</h5>
                                            <br/>
                                            <input type="text" id="txtsearchsite" />
                                            
                                            
                                            <button onclick="loadtodiv('#right-content','sites.jsp?q='+document.getElementById('txtsearchsite').value);">Chercher</button> </div>
				...
				<div class="lines-dotted-short"></div>
					...
					<div class="search" >
                                            <h5>Chercher un BSC:</h5>
                                            <br/>
                                            <input type="text" id="txtsearchbsc" />
                                            
                                            
                                            <button onclick="loadtodiv('#right-content','bsc.jsp?q='+document.getElementById('txtsearchbsc').value);">Chercher</button> </div>
...
<div id="right-content">
    <div id="map_canvas" style="position: relative; margin-left: 0;margin-right: 0 ;z-index: 100;width: 110%;height: 500px"></div>
</div>
...
<div id="footer">
	<!--  start footer-left -->
	<div id="footer-left">
	| EVO Group &copy; Copyright <a href="http://www.evogroup.hostoi.com/" target="_blank">EVO Group</a>. All rights reserved.</div>
	<!--  end footer-left -->
	<div class="clear">&nbsp;</div>
</div>
<!-- end footer -->
