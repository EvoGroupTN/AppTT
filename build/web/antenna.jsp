...
<html>
    ...
    <body>
        ...
        if(request.getParameter("q")!=null){
            ...
            rs = db.S.executeQuery("Select * from Antenne where idAntenne like '%"+q+"%' or idequipement like '%"+q+"%' or typeAnt like '%"+q+"%' or Ant900 like '%"+q+"%' or Ant1800 like '%"+q+"%' or Ant2100 like '%"+q+"%' or idBTS like '%"+q+"%'");
        ...
        while(rs.next()){
            ...
            <div id="<%=ids%>" class="contentrow">
                ...
                <div style="float: left;"><a  href='#' onclick="showsiteinfo('getantenna.jsp?idb=<%=ids%>');">Afficher</a></div>&nbsp;<div style="float: left;<%=vis%>">&nbsp;| <a href='getantenna.jsp?edit&idb=<%=ids%>' target='frminfo' onclick="showinfo()">Modifier</a> | <a href="actions?action=delete&what=Antenne&ids=<%=ids%>" target='frmsub' onclick="loadtodiv('#<%=ids%>','done.html')"">Supprimer</a></div><br/>
